...
const Subscription: React.FC = () => {
  ...
  return (
    <div className="h-full overflow-auto custom-scrollbar">
      <div className="max-w-7xl mx-auto space-y-12 pb-2">
        {/* Header */}
          ...
          {plans
            ...
            .map((plan) => {
              ...
              return (
                <div
                  key={plan.id}
                  className={`relative flex flex-col p-8 bg-white dark:bg-gray-800 rounded-2xl border transition-all duration-500 ${isCurrent
                ...
                >
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-6 rounded-xl font-bold transition-all ${isCurrent || isSubmitting || plan.id === pendingPlanId
        ...
        {/* Support CTA */}
        <div className="bg-gradient-to-br from-indigo-900 to-blue-900 rounded-2xl md:rounded-3xl p-8 md:p-16 text-white relative overflow-hidden shadow-2xl mx-4 md:mx-0">
