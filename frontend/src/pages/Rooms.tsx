...
import RoomTable from './Rooms/components/RoomTable';
...
const Rooms: React.FC = () => {
  ...
  }, [editingId, formData, isSubmitting, t, handleCloseModal, refreshRooms]);
    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      >
        {loading ? (
          ...
          <RoomTable
            rooms={filteredRooms.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage)}
