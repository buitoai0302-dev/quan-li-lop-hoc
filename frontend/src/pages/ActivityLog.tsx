...
const ActivityLog: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      <div className="w-full space-y-4 sm:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 shrink-0 pb-4">
      ...
      <div className="flex-1 w-full overflow-hidden bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 flex flex-col mb-4 sm:mb-8">
        {loading ? (
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar divide-y divide-gray-50 dark:divide-gray-700/50">
            {activities.map((act) => (
              <div key={act.id} className="p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors flex gap-3 sm:gap-5 group">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-gray-50 dark:bg-gray-900 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
          ...
          <div className="flex-1 flex items-center justify-center p-12 sm:p-20 text-center text-gray-400 italic text-sm">
        ...
        <div className="p-4 sm:p-6 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg disabled:opacity-30 hover:bg-gray-50 transition-colors shadow-sm active:scale-95"
            >
              <ChevronLeft size={18} />
            </button>
            <button
