...
const ImportData: React.FC = () => {
  ...
  return (
    <div className="h-full overflow-auto custom-scrollbar">
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl p-3 sm:p-5 rounded-xl sm:rounded-2xl shadow-2xl shadow-gray-200/50 dark:shadow-none border border-white dark:border-gray-700/50 min-h-full flex flex-col transition-all">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex items-center justify-between mb-4 px-1">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-100 dark:border-gray-800 rounded-lg text-[9px] font-black uppercase tracking-widest text-gray-400 hover:text-primary transition-all active:scale-95"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2 sm:gap-3">
            ...
            <div className="md:col-span-3">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-2 text-[9px] font-black uppercase tracking-widest text-primary bg-primary/5 hover:bg-primary/10 border border-primary/20 rounded-lg transition-all active:scale-95 shadow-sm group/btn"
              >
        ...
        {isGuideOpen && (
          <div className="mb-6 p-4 bg-gray-50/50 dark:bg-gray-900/30 rounded-xl border border-gray-100 dark:border-gray-800 animate-in slide-in-from-top-2 duration-300 relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 relative z-10">
              {(importType === 'students' || importType === 'teachers') && (
                <>
                  <div className="px-3 py-1.5 bg-rose-50/50 dark:bg-rose-900/10 rounded-md border border-rose-100/50 dark:border-rose-800/20 flex items-center gap-2">
                  ...
                  <div className="px-3 py-1.5 bg-blue-50/50 dark:bg-blue-900/10 rounded-md border border-blue-100/50 dark:border-blue-800/20 flex items-center gap-2">
              ...
              {importType === 'rooms' && (
                <>
                  ...
                  <div className="px-3 py-1.5 bg-blue-50/50 dark:bg-blue-900/10 rounded-md border border-blue-100/50 dark:border-blue-800/20">
        ...
        {!file || parsedData.length === 0 ? (
          <div className="flex-1 min-h-[280px] flex flex-col items-center justify-center border-2 border-dashed border-gray-100 dark:border-gray-800 rounded-2xl bg-gray-50/30 dark:bg-gray-900/20 p-8 relative group transition-all hover:border-primary/30 hover:bg-primary/[0.02] overflow-hidden">
            <input
              type="file"
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-24 h-24 rounded-2xl bg-white dark:bg-gray-800 shadow-2xl shadow-primary/10 flex items-center justify-center text-primary mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-700 border border-gray-100 dark:border-gray-700 relative">
                ...
                {file ? (
                  <div className="relative z-30 animate-in fade-in zoom-in duration-300">
                    ...
                    <button
                      ...
                      className="px-10 py-3.5 bg-primary hover:bg-primary-dark text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-primary/20 transition-all active:scale-95"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="pt-4 flex items-center justify-center gap-3">
                      <span className="px-3 py-1 bg-white dark:bg-gray-800 rounded-md text-[9px] font-black text-gray-400 uppercase tracking-widest border border-gray-100 dark:border-gray-700 shadow-sm">CSV</span>
                      <span className="px-3 py-1 bg-white dark:bg-gray-800 rounded-md text-[9px] font-black text-gray-400 uppercase tracking-widest border border-gray-100 dark:border-gray-700 shadow-sm">XLSX</span>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="flex flex-col flex-1 min-h-0 animate-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-primary/[0.03] dark:bg-primary/[0.05] border border-primary/10 rounded-xl mb-4">
              <div className="flex items-center gap-4 min-w-0">
                <div className="w-12 h-12 rounded-xl bg-white dark:bg-gray-800 shadow-sm flex items-center justify-center text-primary border border-primary/10 shrink-0">
                  <FileText size={24} />
                </div>
              ...
              <button
                ...
                className="px-4 py-2 flex items-center gap-2 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/30 rounded-lg transition-all text-[9px] font-black uppercase tracking-widest self-end sm:self-center"
              >
                <Trash2 size={16} />
            ...
            <div className="flex-1 overflow-auto bg-white/50 dark:bg-gray-900/20 border border-gray-100 dark:border-gray-800 rounded-xl shadow-inner relative">
              {isProcessing ? (
            ...
            <div className="mt-6 flex justify-end">
              <button
                ...
                className={`group flex items-center px-10 py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] text-white shadow-2xl transition-all active:scale-95 ${isUploading || parsedData.length === 0
