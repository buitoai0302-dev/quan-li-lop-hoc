...
const Help: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary to-indigo-600 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {categories.map((cat) => (
          <div key={cat.id} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all group">
            <div className="flex items-start gap-4 mb-4">
              <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl group-hover:scale-110 transition-transform">
                {cat.icon}
              </div>
      ...
      {selectedCategory && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
            {/* Modal Header */}
            ...
            <div className="p-8 overflow-y-auto flex-1 space-y-6">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-2xl flex gap-4 items-start border border-blue-100 dark:border-blue-800/50">
              ...
              <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                ...
                <div className="space-y-3">
                  {selectedCategory.steps.map((step: string, i: number) => (
                    <div key={i} className="flex gap-4 p-3 bg-gray-50 dark:bg-gray-700/30 rounded-xl">
                      <div className="w-6 h-6 bg-primary text-white rounded-lg flex items-center justify-center font-bold text-xs shrink-0 shadow-sm">
                        {i + 1}
                      </div>
            ...
            <div className="p-6 border-t border-gray-100 dark:border-gray-700 flex justify-end">
              <button 
                onClick={() => setSelectedCategory(null)}
                className="px-8 py-2.5 bg-primary text-white rounded-xl font-bold hover:bg-primary-dark transition-all shadow-lg shadow-primary/20 active:scale-95"
              >
                {t('common.close')}
              </button>
            </div>
        ...
        <div className="max-w-xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="flex items-center gap-3 px-8 py-4 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-2xl font-black hover:bg-gray-50 transition-all shadow-sm"
            >
