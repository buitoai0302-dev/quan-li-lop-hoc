      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="EduSchedule Logo" className="w-10 h-10 rounded-xl shadow-lg shadow-primary/20" />
            <span className="text-xl font-black text-slate-900 dark:text-white tracking-tight">EduSchedule</span>
          </div>

          {/* Nav Links (Desktop) */}
          <nav className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-bold text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-white transition-colors">
              {t('landing.features', 'Features')}
            </a>
            <a href="#pricing" className="text-sm font-bold text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-white transition-colors">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <button
              ...
              className="group flex items-center justify-center w-10 h-10 text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-white bg-slate-50 hover:bg-primary/5 dark:bg-slate-800 dark:hover:bg-slate-700 rounded-xl transition-all"
