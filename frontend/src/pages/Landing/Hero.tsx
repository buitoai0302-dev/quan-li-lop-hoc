      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4 sm:gap-8 text-sm font-bold text-slate-500 dark:text-slate-400">
          <div className="flex items-center gap-2">
            <CheckCircle2 size={16} className="text-emerald-500" /> {t('landing.noCreditCard', 'No credit card required')}
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle2 size={16} className="text-emerald-500" /> {t('landing.cancelAnytime', 'Cancel anytime')}
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle2 size={16} className="text-emerald-500" /> {t('landing.freeSupport', 'Free 24/7 support')}
          </div>
        </div>
          ...
          <div className="rounded-2xl sm:rounded-[2rem] border border-slate-200/50 dark:border-slate-700/50 bg-white/50 dark:bg-slate-800/50 backdrop-blur-xl p-2 sm:p-4 shadow-2xl overflow-hidden">
            <img 
              ...
              onError={(e) => {
                ...
                target.src = 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=2000';
              }}
            />
          </div>
        </div>
