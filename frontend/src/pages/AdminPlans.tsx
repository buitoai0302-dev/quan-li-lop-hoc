    ...
    <div className="h-full overflow-auto custom-scrollbar">
      <div className="space-y-8 max-w-7xl mx-auto pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <div key={plan.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col group transition-all hover:shadow-2xl hover:border-primary/20">
              {/* Plan Header - Compact */}
              <div className="p-5 border-b border-gray-50 dark:border-gray-700/50 bg-gray-50/30 dark:bg-gray-900/20 flex justify-between items-center">
                <div className="flex items-center gap-3 min-w-0">
                  <div className={`w-10 h-10 shrink-0 rounded-lg flex items-center justify-center shadow-md ${plan.code === PLAN_CODES.FREE ? 'bg-gray-100 text-gray-400' :
                ...
                <div className="flex flex-col items-center gap-1 bg-white dark:bg-gray-800 p-1.5 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm shrink-0">
              ...
              <div className="p-4 bg-white dark:bg-gray-800 grid grid-cols-2 gap-3 border-b border-gray-50 dark:border-gray-700/50">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-gray-900/40 border-none rounded-lg px-3 py-2 text-sm font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/20 transition-all outline-none"
                  />
                </div>
                      ...
                      <div key={key} className="space-y-1">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-lg px-3 py-2 text-xs font-black text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/10 outline-none transition-all"
                          />
                ...
                <div className="space-y-3 pt-4 border-t border-gray-50 dark:border-gray-700/50">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {Object.entries(plan.features).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between p-2.5 bg-gray-50/50 dark:bg-gray-900/30 rounded-lg border border-transparent hover:border-gray-100 dark:hover:border-gray-700 transition-all">
              ...
              <div className="p-4 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700">
                <button
                  ...
                  className="w-full py-3 bg-primary hover:bg-primary-dark text-white rounded-lg font-black text-[10px] uppercase tracking-[0.2em] shadow-lg shadow-primary/10 flex items-center justify-center gap-2 transition-all active:scale-[0.98] disabled:opacity-50"
                >
                  {savingId === plan.id ? (
