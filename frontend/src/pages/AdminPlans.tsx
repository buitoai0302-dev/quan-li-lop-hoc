            ...
            <div className="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/30 flex justify-between items-center">
              ...
              <div className="text-right space-y-3">
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-gray-500 uppercase font-bold tracking-tighter">VND / {t('common.month', 'month')}</span>
                  <input 
                    type="number"
                ...
                <div className="flex flex-col items-end">
                  <span className="text-[10px] text-gray-500 uppercase font-bold tracking-tighter">USD / {t('common.month', 'month')}</span>
                  <input 
                    type="number"
                ...
                <div className="grid grid-cols-2 gap-4">
                  {Object.entries(plan.limits).map(([key, value]) => (
                    <div key={key}>
                      ...
                      />
                      <p className="text-[10px] text-gray-400 mt-1">(-1 = {t('common.unlimited', 'Unlimited')})</p>
                    </div>
                  ))}
                </div>
              </div>
