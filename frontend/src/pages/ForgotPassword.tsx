        ...
        <div className="bg-white/40 dark:bg-gray-800/50 backdrop-blur-xl py-6 px-6 sm:px-10 shadow-xl shadow-slate-200/50 dark:shadow-none rounded-[2rem] sm:rounded-[2.5rem] border border-slate-200/50 dark:border-gray-700/50">
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-black text-slate-900 dark:text-white mb-1">{t('auth.resetEmailSentTitle')}</h3>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="space-y-1">
                <label htmlFor="email" className="block text-[9px] font-black text-slate-400 dark:text-gray-500 uppercase tracking-widest ml-1">{t('auth.email')}</label>
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="block w-full pl-11 pr-5 py-2.5 bg-slate-50/80 dark:bg-gray-900/50 border border-slate-100 dark:border-gray-800 dark:text-white rounded-xl sm:rounded-2xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all placeholder:text-slate-300 dark:placeholder:text-gray-600" 
                  />
                </div>
              </div>
              <button 
          ...
          <div className="mt-6 text-center pt-4 border-t border-slate-100 dark:border-gray-700/50">
            <Link to="/login" className="inline-flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-primary transition-all">
