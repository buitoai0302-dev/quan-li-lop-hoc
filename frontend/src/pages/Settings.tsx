...
const Settings: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* Side Navigation Sub-menu - Icon-centric & Single Row on Mobile */}
      <aside className="w-full lg:w-56 shrink-0 sticky top-16 lg:top-16 z-20 self-start will-change-transform">
        <div className="bg-white/90 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl lg:rounded-3xl shadow-xl lg:shadow-gray-200/50 dark:shadow-none border border-white dark:border-gray-700/50 p-0.5 lg:p-3 flex lg:flex-col items-center lg:items-stretch justify-center lg:justify-start gap-1 overflow-x-auto no-scrollbar">
          {navItems.map((item) => (
            <button
              key={item.id}
              onClick={() => setActiveSection(item.id)}
              className={`lg:flex-none flex flex-col lg:flex-row items-center lg:justify-between px-0.5 py-2 lg:px-4 lg:py-3 rounded-xl lg:rounded-2xl transition-all duration-300 group min-w-[55px] lg:min-w-0 ${activeSection === item.id
      ...
      <div className="flex-1 min-w-0">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-[2rem] lg:rounded-[2.5rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-white dark:border-gray-700/50 p-5 sm:p-8 lg:p-10 min-h-[500px] lg:min-h-[600px] transition-all">
            ...
            <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl px-5 py-3 text-sm font-bold text-gray-900 dark:text-white focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all"
                  />
                </div>
              ...
              <div className="pt-6">
                <button
                  ...
                  disabled={saving}
                  className="w-full sm:w-auto px-10 py-3.5 bg-primary hover:bg-primary-dark text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-primary/20 transition-all active:scale-95 disabled:opacity-50"
                >
          ...
          {activeSection === 'profile' && (
            <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-3xl border border-gray-100 dark:border-gray-800 flex items-center justify-between group">
            ...
            <section className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {Object.keys(menuSettings).map((key) => (
                  <div key={key} className="p-2 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-800 flex items-center justify-between group hover:border-primary/20 transition-all">
                    <div className="flex items-center gap-2">
                      <div className={`p-1 rounded-lg bg-white dark:bg-gray-800 shadow-sm ${menuSettings[key] ? 'text-primary' : 'text-gray-400'}`}>
          ...
          {activeSection === 'integration' && (
            <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="p-6 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div className="flex items-center gap-5 min-w-0">
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-inner shrink-0">
                ...
                <button
                  ...
                  className={`w-full sm:w-auto px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${isGoogleConnected
              ...
              {isGoogleConnected && (
                <div className="p-6 bg-primary/[0.03] dark:bg-primary/[0.05] rounded-3xl border border-dashed border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div className="flex items-center gap-4 text-primary">
                    <div className={`p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-sm border border-primary/10 shrink-0 ${syncing ? 'animate-pulse' : ''}`}>
                  ...
                  <button
                    ...
                    disabled={syncing}
                    className="w-full sm:w-auto px-8 py-3.5 bg-primary text-white text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50"
                  >
            ...
            <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              {!hasApiAccess ? (
                <div className="p-8 bg-gradient-to-br from-indigo-50 via-blue-50 to-white dark:from-indigo-900/10 dark:via-blue-900/10 dark:to-gray-800 rounded-[2rem] border border-blue-100 dark:border-blue-800/30 relative overflow-hidden group">
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center max-w-md mx-auto">
                    ...
                    <button
                      ...
                      className="mt-8 px-10 py-4 bg-primary hover:bg-primary-dark text-white text-[10px] font-black uppercase tracking-widest rounded-2xl transition-all shadow-2xl shadow-primary/30 active:scale-95"
                    >
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 relative group">
                        <input
                          ...
                          readOnly
                          value={apiKey || ''}
                          className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl px-5 py-4 text-sm font-mono focus:outline-none transition-all shadow-inner"
                          placeholder={t('settings.apiKeyPlaceholder')}
                        />
                        {!apiKey && (
                          <div className="absolute inset-0 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-[2px] flex items-center justify-center rounded-2xl text-[10px] text-gray-400 font-black uppercase tracking-widest">
                      ...
                      {apiKey && (
                        <button
                          ...
                          className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-sm active:scale-95"
                          title="Copy Key"
                        >
                      ...
                      <button
                        ...
                        className="p-4 bg-primary hover:bg-primary-dark text-white rounded-2xl transition-all shadow-xl shadow-primary/20 disabled:opacity-50 active:scale-95"
                        title={t('settings.generate')}
                      >
                        <RefreshCw size={22} className={generatingKey ? 'animate-spin' : ''} />
                      </button>
                    </div>
                    <div className="mt-4 px-4 py-3 bg-amber-50 dark:bg-amber-900/10 rounded-xl border border-amber-100 dark:border-amber-800/30 flex items-center gap-2">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900/30 p-6 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700">
          ...
          {activeSection === 'appearance' && (
            <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {[
                  { id: 'light', icon: <Palette className="text-amber-500" />, label: t('settings.light') },
                  { id: 'dark', icon: <Palette className="text-indigo-500" />, label: t('settings.dark') },
                  { id: 'system', icon: <Palette className="text-gray-500" />, label: t('settings.system') },
                ].map((tItem) => (
                  <button
                    key={tItem.id}
                    onClick={() => setTheme(tItem.id as any)}
                    className={`p-6 rounded-3xl border-2 transition-all flex flex-col items-center gap-4 group ${theme === tItem.id
                      ? 'border-primary bg-primary/5 shadow-xl shadow-primary/5'
                      : 'border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 hover:border-primary/50'
                      }`}
                  >
                    <div className={`p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-sm transition-transform group-hover:scale-110 ${theme === tItem.id ? 'text-primary' : 'text-gray-400'}`}>
                      {tItem.icon}
                    </div>
                    <span className={`text-xs font-black uppercase tracking-widest ${theme === tItem.id ? 'text-primary' : 'text-gray-500'}`}>
                      {tItem.label}
                    </span>
                  </button>
                ))}
