...
const Card: React.FC<CardProps> = ({ 
  ...
  return (
    <div className={`bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800/50 overflow-hidden flex flex-col ${className}`}>
      {header && (
