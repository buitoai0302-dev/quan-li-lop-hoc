  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/20 dark:shadow-none hover:shadow-2xl transition-all group">
      <div className="flex items-center justify-between mb-3">
        <div
          className={`p-2.5 rounded-lg text-white ${colors[color]} shadow-md group-hover:scale-110 transition-transform`}
        >
          {icon}
        </div>
        <div
          className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-widest ${bgLight[color]} ${textCol[color]}`}
        >
          {trend}
        </div>
      </div>
