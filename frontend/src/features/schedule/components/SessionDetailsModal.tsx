...
const SessionDetailsModal: React.FC<SessionDetailsModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={t('schedule.sessionDetails')} size="md">
      <div className="space-y-6 py-2">
        <div className="flex items-center gap-4 p-4 bg-primary/5 rounded-xl border border-primary/10">
          ...
          <div>
            <h3 className="text-lg font-black text-gray-900 dark:text-white leading-tight tracking-tight uppercase">
              {session.class_name}
            </h3>
            <Badge
              variant="secondary"
