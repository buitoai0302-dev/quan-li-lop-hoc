    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A] flex items-center justify-center p-6 transition-colors duration-500">
        <div className="bg-white/70 dark:bg-gray-800/50 backdrop-blur-xl p-8 rounded-[2rem] border border-white dark:border-gray-700/50 shadow-2xl text-center max-w-sm w-full animate-in zoom-in-95 duration-500">
          ...
          <p className="text-sm font-black text-rose-500 uppercase tracking-widest mb-4">
            {t('auth.invalidResetLink')}
          </p>
          <Link
            to="/forgot-password"
            className="inline-flex items-center gap-2 text-xs font-black text-primary hover:text-primary-dark uppercase tracking-widest transition-all underline decoration-2 underline-offset-4"
          >
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  icon={<Lock />}
                  className={
                    confirmPassword && password !== confirmPassword ? 'ring-2 ring-rose-500' : ''
                  }
                />
                {confirmPassword && password !== confirmPassword && (
                  <p className="mt-1.5 ml-1 text-[9px] font-bold text-rose-500 uppercase tracking-tight">
